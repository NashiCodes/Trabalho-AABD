...
2. Popular o banco com dados de exemplo (78 documentos)
...
3. **exercicios**: Catálogo com 10 exercícios detalhados
...
O script de população gera **78 documentos**:

- 10 educadores com especialidades variadas
- 10 alunos com perfis diversos
- 10 exercícios de diferentes grupos musculares
- 8 treinos com objetivos variados
- 10 avaliações de educadores
- 10 execuções de treinos registradas
- 10 mensagens trocadas
- 10 notificações geradas
